/**
 * EuthList — Vercel Serverless API
 * ===================================
...
const ALLOWED_SETTINGS = [
  ...
  "donationMethod", "paypalLink", "gofundmeLink", "donationWhatsappNumber",
  "seoMetaTitle", "seoMetaDescription", "seoKeywords",
  "seoOgTitle", "seoOgDescription", "seoOgImage", "seoCanonicalUrl", "seoTwitterCard",
  "donationStripeEnabled",
  "donationWhatsappEnabled", "donationPaypalEnabled", "donationGofundmeEnabled",
  "donationTelegramEnabled", "donationTelegramUsername",
  "donationCryptoEnabled", "donationCryptoAddress", "donationCryptoNetwork", "donationCryptoCoin",
];
...
async function getSmtpConfig() {
  ...
  return {
    ...
    fromName:  s.smtpFromName  || process.env.SMTP_FROM_NAME  || "EuthList",
...
<div class="h"><h1>🐾 EuthList</h1><p>euthlist.com — Urgent Pet Rescue List</p></div>
<div class="b">${content}</div>
<div class="f"><p>EuthList · hello@euthlist.com · euthlist.com</p></div>
</div></body></html>`;
}
...
async function sendOrderConfirmationEmail({ to, amountTotal, currency, items, trackingNumber }) {
  ...
  const trackBadge = trackingNumber
    ? `<div style="background:#fff8f0;border:1px solid #f5c89a;border-radius:10px;padding:14px 18px;margin:18px 0;text-align:center">
        ...
        <p style="margin:6px 0 0;font-size:12px;color:#888">Track your order at euthlist.com/track</p></div>` : "";
  await sendEmail({
    to,
    subject: `Your EuthList order is confirmed — ${curr} ${amount} 🐾`,
    html: emailBase(`
